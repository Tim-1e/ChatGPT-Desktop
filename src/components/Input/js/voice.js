...
class Voice {
        ...
        init() {
            ...
            try {
                if (!self.appId || !self.apiKey || !self.apiSecret) {
                    ...
                    self.webWorker = new Worker('./src/components/Input/js/transcode.worker.js');
        ...
        setResultText({ resultText, resultTextTemp } = {}) {
            console.log("text change to",resultText,resultTextTemp);
        ...
        recorderInit() {
            ...
            try {
                ...
                this.audioContext.audioWorklet.addModule('./src/components/Input/js/audio-processor.js');
            ...
            let getMediaSuccess = _ => {
                // 创建一个用于通过JavaScript直接处理音频的AudioWorkletNode
